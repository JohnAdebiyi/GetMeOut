...
public class SettingManagerMainMenu : MonoBehaviour {
    ...
    public void OnMusicVolumeMainMenu()
    {
        ...
        float _volume = gameSettings.musicVolume = musicVolumeSliderMainMenu.value;
        musicSourceMainMenu.Volume(_volume);
    }

    public void OnSfxVolumeMainMenu()
    {
        FindObjectOfType<SFX_Manager>().Play("buttonSound");
        float _volume = gameSettings.sfxVolume = sfxVolumeSliderMainMenu.value;
        sfxSourceMainMenu.Volume(_volume);
    }
