...
public class LaptopGame3_ButtonColorTrans : MonoBehaviour {
    ...
    IEnumerator OnPressed_ButtonEnter()
    {
        buttonEnter.color = onPressedColor;
        yield return new WaitForSeconds(colorTime);
        buttonEnter.color = normalColor;
    }
    ...
    void Update()
    {
        ...
        if (_inTrigger)
        {
            ...
            if (Input.GetKeyDown(KeyCode.KeypadEnter) || Input.GetKeyDown(KeyCode.Return))
            {
                ...
                StartCoroutine(OnPressed_ButtonEnter());
            }
